...
<div id="comments" class="comments-area">
   ...
   <nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
      ...
      <div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'Amazing_Walls_Domain') ); ?></div>
      <div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'Amazing_Walls_Domain' ) ); ?></div>
   </nav>
   ...
   <?php
      ...
      ?>
   <p class="nocomments"><?php _e( 'Comments are closed.', 'amazing_walls' ); ?></p>
   <?php endif; ?>
   <?php comment_form(); ?>
</div>
