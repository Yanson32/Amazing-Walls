    ...
    <?php if ( have_posts() ) : ?>
      <?php while ( have_posts() ) : ?>
        ...
        <div id="post-<?php the_ID(); ?>" <?php post_class('archive_single_post clearfix'); ?> >
          ...
          <?php $image_width = wp_get_additional_image_sizes()['aw_mobile_post_thumbnail']['width']; ?>
          <?php $image_height = wp_get_additional_image_sizes()['aw_mobile_post_thumbnail']['height']; ?>
