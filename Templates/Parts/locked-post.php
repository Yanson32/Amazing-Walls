...
<!-- get the defined width and height of the post featured image -->
	...
	<?php $image_height = $_wp_additional_image_sizes['post-thumbnail']['height']; ?>
   	<a href="<?php echo $thumb_link; ?>"><img class="post-thumbnail" src="<?php echo $image; ?>" alt="Post Locked" style="width:<?php echo $image_width; ?>; height:<?php echo $image_height; ?>"></a>
</div>
