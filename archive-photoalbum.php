      ...
      <?php if ( have_posts() ) : ?>
        <?php while ( have_posts() ) : ?>
          ...
          <div id="post-<?php the_ID(); ?>" <?php post_class('archive_single_post'); ?> >
            ...
            <?php $image_width = wp_get_additional_image_sizes()['aw_photoalbum_post_thumbnail']['width']; ?>
            <?php $image_height = wp_get_additional_image_sizes()['aw_photoalbum_post_thumbnail']['height']; ?>
            ...
            <?php if ( has_post_thumbnail() ): ?>
              <a href="<?php echo $thumb_link; ?>"><?php the_post_thumbnail('photoalbum-thumbnail'); ?></a>
            <?php else: ?>
